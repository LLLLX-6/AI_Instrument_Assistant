...
`docs/architecture/aia-jlceda-v1-state-machine.md`. Phase 5B.3b permits exactly
two authenticated, read-only business operations: `eda.document.get_active`
and `eda.selection.get`. Highlight remains outside the remote operation
allowlist.
